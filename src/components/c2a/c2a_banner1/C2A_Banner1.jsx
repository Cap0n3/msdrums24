            ...
            <Grid container spacing={2}>
                ...
                >
                    <Slide
                        direction="down"
                        in={isVisible}
                        container={leftCell_container.current}
                        style={{
                    ...
                    >
                        <Box>
                            ...
                            >
                                Cours de guitare donné par un Alex, un musicien
                                professionnel avec plus de 20 ans d'expérience
                                de la scène et du studio et de l'enseignement.
                            </Typography>
                        </Box>
                    </Slide>
                </Grid>
                ...
                >
                    <Slide
                        direction="left"
                        in={isVisible}
                        container={middleCell_container.current}
                        style={{
                            transitionDelay: isVisible ? "1000ms" : "0ms",
                        }}
                    >
                ...
                >
                    <Slide
                        direction="down"
                        in={isVisible}
                        container={rightCell_container.current}
                        style={{
                            transitionDelay: isVisible ? "1000ms" : "0ms",
                        }}
                    >
