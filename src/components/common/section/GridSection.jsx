...
const GridSection = ({ contents, backgroundColor, smScreen_cellSpacing, reverse }) => {
    ...
    const orderedContents = isMdUp && reverse ? [...contents].reverse() : contents;
                        ...
                        {contents &&
                            orderedContents.map((content, index) => (
                                    <ResponsiveCell
                                        ...
                                        sx={{
                                            ...content.sx,
                                            paddingTop: index === 0 ? 0 : { xs: smScreen_cellSpacing, sm: smScreen_cellSpacing, md: 0 },
                                        }}
                                    />
                            ))}
                    </Grid>
